 ...
 * @author tuong
 */
public class FetchHeadPhoneByPriceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<ProductDTO> list = pdao.fetchHeadPhoneByPrice(price);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FetchHeadPhoneByPriceServlet.class.getName()).log(Level.SEVERE, null, ex);
