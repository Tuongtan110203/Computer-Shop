 ...
 * @author tuong
 */
public class ManagementRevenueServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("orderDetailsList1", orderDetailsList1);
            request.getSession().setAttribute("totalMoney", totalMoney);
            request.getRequestDispatcher("managementRevenue.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
