...
public class UserServlet extends HttpServlet {
    ...
    private String ShowProductByUser = "showUser.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ShowProductByUser;
        try {
            ProductDAO pdao = new ProductDAO();
            List<ProductDTO> list = pdao.getTop6Product();
            OrderDetailsDAO odao = new OrderDetailsDAO();
            CartDAO cartDAO = new CartDAO();
            List<OrderDetailsDTO> listOrder = odao.selectTopSellingProducts();
            ...
            session.setAttribute("listProductByUser", list);
            session.setAttribute("listBestSeller", listOrder);
