...
public class searchServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double priceFrom = Double.MIN_VALUE;
        ...
        switch (searchOption) {
            case "name":
                list = pdao.searchProductByName(searchKeyword);
                break;
            case "id":
                list = pdao.searchProductById(searchKeyword);
                break;
            case "price":
                list = pdao.searchProductByPriceRange(priceFrom, priceTo);
                break;
            case "releaseDate":
                list = pdao.searchProductByReleaseDate(searchKeyword);
                break;
            default:
