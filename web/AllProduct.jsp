                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-9">
                                <div id="content" class="row g-4 justify-content-center marginProduct">
                                    <c:forEach var="product" items="${sessionScope.listAllProduct}">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <p class="text-dark fs-5 fw-bold mb-0">
                                                            <fmt:formatNumber pattern="#,###">${product.price}</fmt:formatNumber> VND
                                                                ...
                                                                <button style="margin-left: 70px;" type="button" class="btn border border-secondary rounded-pill px-3 text-primary" onclick="addToCart('${product.id}')"> 
