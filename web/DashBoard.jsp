                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                    ...
                                    <li>
                                        <a href="headPhone" class="nav-link px-0"> <span class="d-none d-sm-inline">Key Board</span> </a>
                                    </li>
                                    <li>
                                        <a href="keyBoard" class="nav-link px-0"> <span class="d-none d-sm-inline">Head Phone</span> </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <div class="row g-4 justify-content-center">
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="counter bg-white rounded p-5">
                                            ...
                                            <p id="totalUsers" class="card-text">${sessionScope.totalNonAdminUsers}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="counter bg-white rounded p-5">
                                            ...
                                            <c:set var="totalOrder" value="${sessionScope.totalOrder}" scope="session" />
                                            <p id="totalOrders" class="card-text">${totalOrder}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="counter bg-white rounded p-5">
                                            ...
                                            <p id="totalProducts" class="card-text">${sessionScope.totalProducts}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="counter bg-white rounded p-5">
                                            ...
                                            <c:set var="totalMoney" value="${sessionScope.totalMoney}" scope="session" />
                                            <p id="totalRevenue" class="card-text"><fmt:formatNumber value="${totalMoney}" pattern="#,###"/> VND</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="counter bg-white rounded p-5">
                                            ...
                                            <c:set var="totalView" value="${sessionScope.totalView}" scope="session" />
                                            <p id="totalOrders" class="card-text">${totalView}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
