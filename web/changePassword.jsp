...
<html>
    <head>
        ...
        <style>
            ...
            .password-form {
                box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Điều chỉnh giá trị để thay đổi độ đậm và màu sắc của box shadow */
                padding: 20px; /* Thêm padding cho form */
                border-radius: 10px; /* Bo tròn góc cho form */
                margin-top: 20px; /* Thêm khoảng cách từ trên xuống form */
            }
        </style>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="password-form">
                                <h1 class="text-center mb-4">Change Password Form</h1>
                                <form action="DispatchServlet" method="post">
                                    <div class="mb-3">                                     
                                        Old Password:<input type="password" class="form-control" id="oldPass" name="oldPass">
                                    </div>
                                    <div class="mb-3">
                                        New Password:<input type="password" class="form-control" id="newPass" name="newPass">
                                    </div>
                                    <div class="mb-3">
                                        Confirm Password:<input type="password" class="form-control" id="confirmPass" name="confirmPass">
                                    </div>
                                    <div class="text-center">
                                        <input type="hidden" name="user" value="${sessionScope.loginUsername}">
                                        <input type="submit" class="btn btn-primary" name="btSubmit" value="Change"/>
