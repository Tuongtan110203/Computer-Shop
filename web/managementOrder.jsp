                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="managementOrder.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">Management Order</span> </a>
                                    </li>
                                    <li>
                    ...
                    <table class="table  table-bordered  border-primary">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width: 0%;">Quantity</th>                              
                                <th scope="col" style="width: 9%;">Order Date</th>
                                <th scope="col" style="width: 4%;">FullName</th>                             
                                <th scope="col" style="width: 7%;">Address</th>                             
                                <th scope="col" style="width:4%;">Phone</th>                             
                                <th scope="col" style="width:11%;">Notice</th>                             


                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="order" items="${sessionScope.orderDetailsList}">
                                <tr>
                                    <td>${order.orderId}</td>
                                    <td>${order.name}</td>
                                    <td>${order.quantity}</td>
                                    <!--<td><fmt:formatNumber value="${order.totalMoney}" pattern="#,###"/> VND</td>-->                            
                        ...
                        <tfoot>
                            <tr>
                                <c:set var="c" value="${sessionScope.CountOrderDetaisl}" />
                                <td colspan="5" align="left"><strong>Total: ${c} Order</strong></td> 
                                
                            </tr>
                             <tr>
                                <c:set var="c" value="${sessionScope.SumQuantityOrderDetails}" />
                                <td colspan="5" align="left"><strong>Total: ${c} Quantity</strong></td> 
