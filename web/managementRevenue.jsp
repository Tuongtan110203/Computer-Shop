                    ...
                    <table class="table  table-bordered  border-primary">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width: 15%;">Money</th>    
                        ...
                        <tbody>
                            <c:forEach var="order" items="${sessionScope.orderDetailsList1}">
                                <tr>
                                    <td>${order.orderId}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="5" align="left"><strong>Total:</strong> <fmt:formatNumber value="${totalMoney}" pattern="#,###"/> VND</td>
                            </tr>
                        </tfoot>
                    </table>            
                </div>
