        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
             ...
             <div class="col py-3 " style="padding: 0px!important">
                    <!--<h1 id="view">View Profile User</h1>-->
                    <table  class="table  table-bordered  border-primary">
                        <tr>
                            ...
                            <th scope="col" style="width: 10%;">isAdmin</th>
                        ...
                        <c:forEach var="user" items="${listUser}">
                            <tr>
                                ...
                                <td>${user.isAdmin}</td>
<!--                                <td>
                                    <a href="#" id="delete" onclick="return confirmDelete('${user.username}')" class="btn btn-danger">Delete</a>
                                </td>-->
